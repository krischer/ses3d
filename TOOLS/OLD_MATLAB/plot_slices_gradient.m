...
comp=input('parameter (rho, cp, cs, csh, csv): ', 's');
it=input('iteration: ');

fn=[path_slices_gradient 'slice_log_' plane]
fid_log=fopen(fn,'r');
...
for index=1:length(n)
   ...
   filename=[path_slices_gradient 'slice_' plane '_grad_' comp '_' num2str(n(index)) '_' num2str(it)];
