...
implicit none
	...
	integer, parameter :: nx_max=12		! number of elements in x direction per processor - 1
	integer, parameter :: ny_max=15		! number of elements in y direction per processor - 1
	integer, parameter :: nz_max=17		! number of elements in z direction per processor - 1
